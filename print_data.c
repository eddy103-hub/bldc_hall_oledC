...
void print_data(void){ 
    ...
    clearOledScreen(OLEDC_COLOR_BLACK);
    sprintf(message, "IA: %.1f A    ",Ia);
    oledC_DrawString(2, 20, 1, 2, (uint8_t*)message, GREEN);
    sprintf(message, "IB: %.1f A    ",Ib);
    oledC_DrawString(2, 40, 1, 2, (uint8_t*)message, GREEN);
    sprintf(message, "IC: %.1f A    ",Ic);
    oledC_DrawString(2, 60, 1, 2, (uint8_t*)message, GREEN);
